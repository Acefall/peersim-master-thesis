 ...
 */
public class WeightPotentialObserver implements Control {
    /**
     ...
     */
    private final String weightsLogfile = "/weightPotential.csv";
     ...
     */
    public WeightPotentialObserver(String name) {
    ...
    private double potential(Double[] contributions){
        ...
        for (int i = 0; i < contributions.length; i++) {
            potential += Math.pow(contributions[i]-1/Network.size(), 2);
        }
        return potential;
    }
