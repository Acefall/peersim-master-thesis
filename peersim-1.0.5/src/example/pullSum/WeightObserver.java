 ...
 */
public class WeightObserver implements Control {
    /**
     ...
     */
    private final String weightsLogfile = "/weights.csv";
     ...
     */
    public WeightObserver(String name) {
    ...
    private void writeToBuffer() {
        for (int i = 0; i < Network.size(); i++) {
            ...
            buffer[CommonState.getIntTime() % bufferSize][i] = protocol.getWeight();
        }
    }
